...
public class ToClosestTarget : Policy
{
	...
	public override Vector2 GetPosition()
	{
		...
		Character character = TargetFinder.FindClosestTarget(_findRange, _ownerCollider, _targetLayer.Evaluate(((Component)_ownerCollider).gameObject));
		if ((Object)(object)character == (Object)null)
		{
			Debug.Log((object)"Target is null");
			return Vector2.op_Implicit(((Component)this).transform.position);
		}
		Vector2 result = Vector2.op_Implicit(((Component)character).transform.position);
