...
public class EasedColorBlend : SpriteEffect
{
	...
	public EasedColorBlend(int priority, Color startColor, Color endColor, Curve curve)
		: base(priority)
	{
	...
	internal override void Apply(Renderer renderer)
	{
		...
		_propertyBlock.SetColor(SpriteEffect._baseColor, Color.Lerp(_startColor, _endColor, _curve.Evaluate(_time)));
