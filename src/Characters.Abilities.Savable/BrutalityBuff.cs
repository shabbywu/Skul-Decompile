...
{
	private readonly Stat.Values _buff = new Stat.Values(new Stat.Value(Stat.Category.PercentPoint, Stat.Kind.PhysicalAttackDamage, 0.10000000149011612), new Stat.Value(Stat.Category.PercentPoint, Stat.Kind.MagicAttackDamage, 0.10000000149011612));
	...
	public Sprite icon => Singleton<DarktechManager>.Instance.resource.brutalityBuffIcon;
