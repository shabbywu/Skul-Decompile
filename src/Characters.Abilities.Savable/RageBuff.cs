...
{
	private readonly Stat.Values _buff = new Stat.Values(new Stat.Value(Stat.Category.PercentPoint, Stat.Kind.BasicAttackSpeed, 0.10000000149011612), new Stat.Value(Stat.Category.PercentPoint, Stat.Kind.SkillAttackSpeed, 0.10000000149011612), new Stat.Value(Stat.Category.PercentPoint, Stat.Kind.MovementSpeed, 0.10000000149011612));
	...
	public Sprite icon => Singleton<DarktechManager>.Instance.resource.rageBuffIcon;
