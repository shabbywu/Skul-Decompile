...
public class AttackTutorial : Tutorial
{
	...
	protected override IEnumerator Process()
	{
		...
		for (int i = 0; i < 5; i++)
		{
			PersistentSingleton<SoundManager>.Instance.PlaySound(_giveBoneSoundInfo, ((Component)this).transform.position);
		}
		...
		TutorialSkul tutorialSkul = ((Component)inventory.polymorphOrCurrent).GetComponent<TutorialSkul>();
